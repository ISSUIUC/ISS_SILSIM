...
RASAeroCoefficients RASAeroImport::get_aero_coefficients(double mach,
...
#ifdef RASAERO_DEBUG
    std::cout << std::endl;
    std::cout << "### [RASAeroImport get_aero_coefficients() debug above/below finding]:"
              << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "### [RASAeroImport get_aero_coefficients() debug index finding]:"
              << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "### [RASAeroImport get_aero_coefficients() debug result]:" << std::endl;
