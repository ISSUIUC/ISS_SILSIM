...
if draw_plots:
    ...
    plt.plot(data['KalmanFilter']['Timestamp'], data['KalmanFilter']['Pos'], label="vertical Position (Estimate)")
    plt.plot(data['KalmanFilter']['Timestamp'], data['KalmanFilter']['Vel'], label="vertical velocity (Estimate)")
    plt.plot(data['KalmanFilter']['Timestamp'], data['KalmanFilter']['Accel'], label="vertical Acceleration (Estimate)")
